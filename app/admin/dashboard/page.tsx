...
import { getGlobalActivityLogs } from "@/app/actions/activity";

export default async function AdminDashboard() {
  const activities = await getGlobalActivityLogs(5);
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        ...
        <div className="col-span-4 bg-card border border-border rounded-xl shadow-sm">
          <div className="p-6 border-b border-border flex items-center justify-between">
            ...
            <Link href="/admin/projects" className="text-sm text-primary hover:underline font-medium">View all</Link>
          </div>
          <div className="p-6">
